  ...
  tbody.innerHTML = rows
    ...
    <tr data-id="${u.id}">
      ...
      <td class="row-actions">
        <button type="button" class="btn btn-ghost btn-edit" data-id="${u.id}">编辑</button>
        <button type="button" class="btn btn-danger btn-del" data-id="${u.id}">删除</button>
      </td>
    </tr>`
    )
    .join("");
...
function closeModal() {
  ...
  const createBackdrop = document.getElementById("user-create-modal");
  if (createBackdrop) createBackdrop.classList.add("hidden");
}
